...
export default function Header({page, setPage}) {
    ...
    return (
        ...
        <Stack style={{borderBottom: "1px solid #CCC", paddingBottom: "3px"}} direction="horizontal" gap="3">
            <h2 style={{fontFamily: "Lato, sans-serif", fontWeight: "700", fontSize: smallScreen && "1.8rem"}} className='me-auto'>
            ...
            :
                <Dropdown>
                    ...
                    <Dropdown.Menu>
                        <Dropdown.Item onClick={() => setPage("home")}>Home</Dropdown.Item>
                        <Dropdown.Item onClick={() => setPage("projects")}>Projects</Dropdown.Item>
                        <Dropdown.Item onClick={() => setPage("contact")}>Contact</Dropdown.Item>
                    </Dropdown.Menu>
                </Dropdown>
            }
            {!isAdmin ? 
                <Button variant="primary" onClick={() => setShowAdminModal(true)}>Admin</Button>
            : 
                <>
