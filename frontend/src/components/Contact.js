...
export default function Contact() {
    ...
    function sendEmail(e) {
        ...
        e.target.reset()
        alert("Thank you for your message. I'll try to respond as soon as possible!")
    }
            ...
            <Card style={contactStyle}>
                <Form onSubmit={sendEmail}>
                    <Form.Group className="mb-2" controlId="name" style={titleStyle}>
                        ...
                        <Form.Control autoFocus autoComplete="nope" type="text" name="name" required/>
                    </Form.Group>
                    <Form.Group className="mb-2" controlId="subject" style={titleStyle}>
                        <Form.Label>Subject</Form.Label>
                        <Form.Control autoComplete="off" type="text" name="subject" required/>
                    </Form.Group>
                    <Form.Group className="mb-2" controlId="message" style={titleStyle}> 
                        <Form.Label>Message</Form.Label>
                        <Form.Control autoComplete="off" placeholder='Include your email if you would like a reply' as="textarea" type="text" name="message" required/>
                    </Form.Group>
